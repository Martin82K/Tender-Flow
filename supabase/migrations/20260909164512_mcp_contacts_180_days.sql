-- New and explicitly renewed contact grants last 180 days.
-- Existing grants retain their original consent and expiry; no backfill.
...
BEGIN
  ...
  IF enabled_input THEN
    next_expiry := CASE
      WHEN permission_input = 'tenderflow.contacts.read' THEN NOW() + INTERVAL '180 days'
