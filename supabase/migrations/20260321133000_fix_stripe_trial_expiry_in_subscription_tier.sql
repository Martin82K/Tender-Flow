-- Migration: fix_stripe_trial_expiry_in_subscription_tier
-- Date: 2026-03-21
-- Description: Ensure trial expiration is enforced when trial tier is sourced from stripe_subscription_tier.
