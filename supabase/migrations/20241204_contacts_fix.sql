...
SELECT 'subcontractors table columns:' as info;
...
-- Check RLS policies
SELECT 'RLS policies on subcontractors:' as info;
SELECT policyname, cmd, qual
FROM pg_policies 
WHERE tablename = 'subcontractors';

-- Count existing records
SELECT 'Current record count:' as info, COUNT(*) as count FROM public.subcontractors;
