-- Limit manual cleanup to the personal TODO domain. Project tasks are business
-- records and archived projects intentionally reject every write.
...
COMMENT ON FUNCTION public.delete_my_completed_tasks() IS
  'Deletes completed personal TODO tasks owned by the authenticated user after detaching active personal subtasks.';
