...
interface Props { projectId:string; source?:BudgetSource; previous?:BudgetRevision; hasVersions?:boolean; canAllocate?:boolean; onClose:()=>void; onComplete:(revision?:BudgetRevision)=>void }
export function BudgetImportDialog({projectId,source:initialSource,previous,hasVersions=!!previous,canAllocate=false,onClose,onComplete}:Props) {
