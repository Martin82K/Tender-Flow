...
export const EditBidModal: React.FC<EditBidModalProps> = ({ bid, onClose, onSave, subcontractor, statuses = [], onUpdateSubcontractor }) => {
    ...
    return (
        <div data-help-id="pipeline-edit-bid-modal" className="tf-modal-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="tf-modal-panel tf-pipeline-modal-panel bg-white dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-slate-200 dark:border-slate-700/50 flex flex-col max-h-[90vh]">
                                ...
                                <ThemedNativeSelect
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (cid === "manual") {
                                            ...
                                            const c = subcontractor.contacts.find((contact) => contact.id === cid);
                                            if (c) {
                                                setForm({
                                                    ...form,
