                      ...
                      <td className="py-3 px-2">
                        <div className="relative">
                          <select
                            ...
                            className="rounded-lg bg-white dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600/50 px-2 py-1.5 text-sm text-slate-900 dark:text-white focus:border-primary/50 focus:outline-none disabled:opacity-50 min-w-[160px]"
                          >
                            <option value="">{`Auto (${(
