...
export const AppContent: React.FC = () => {
  ...
  const isCommandCenterVisible = user?.preferences?.commandCenter?.isVisible !== false;
        ...
        if (!isCommandCenterVisible) {
          return (
            <div className="flex min-h-full items-center justify-center px-4 py-10">
              <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
                <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-2xl bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-300">
                  <span className="material-symbols-outlined">visibility_off</span>
                </div>
                <h1 className="text-lg font-bold text-slate-900 dark:text-white">
                  Command Center je skrytý
                </h1>
                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                  Zobrazení můžete kdykoliv znovu zapnout v uživatelském nastavení.
                </p>
                <button
                  type="button"
                  onClick={() =>
                  ...
                  className="mt-5 inline-flex items-center justify-center rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:brightness-110"
                >
                  Otevřít nastavení
                </button>
              </div>
