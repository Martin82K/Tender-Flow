      ...
      <div className="flex flex-col relative w-full bg-slate-950 text-slate-200">
        ...
        <div className="relative p-8 pt-10 text-center border-b border-white/5 z-10">
          ...
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">
            {desktopWelcomeConfig.header.titleStart}{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-200">
              {desktopWelcomeConfig.header.titleHighlight}
            </span>
          </h1>

          <p className="text-slate-400 max-w-md mx-auto">
            {desktopWelcomeConfig.header.subtitle}
          </p>
        ...
        <div className="relative p-8 space-y-8 z-10">
          <div>
            <h2 className="text-xs font-bold uppercase tracking-widest text-orange-500/80 mb-5 px-1">
              {desktopWelcomeConfig.whatsNewSectionTitle}
            </h2>

            <div className="grid gap-4">
              {desktopWelcomeConfig.whatsNew.map((item, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-slate-200 mb-1 group-hover:text-amber-100 transition-colors">
                      {item.title}
                    </h3>
