...
- **Čistší evidence investora**: smlouva, dodatky a uložené faktury se zobrazují jako textové řádky; formulářová pole se objeví až po spuštění editace konkrétního záznamu.
