...
Migrace `20260919085612_prevent_full_company_trial_renewal.sql` ponechává při plném firemním limitu osobní prostor, ale s tarifem Free a stavem expired, nikoli s dalším Enterprise trialem. Nevydává tak opakovaná zkušební období dalším adresám stejné plné firemní domény. Již existující licence nemění. Ověření e-mailu samo o sobě neprokazuje unikátní fyzickou osobu napříč nesouvisejícími doménami; takové omezení vyžaduje samostatné produktové rozhodnutí o ověřování identity.
