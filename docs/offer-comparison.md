...
### Krátkodobé limity placeného zpracování

Rezervace kontroluje pod stejným zámkem firmy také klouzavé limity za hodinu / 24 hodin. Pro jednoho uživatele ve firmě platí 40 / 160 požadavků, 200 / 800 OCR stran a 4 / 16 milionů konzervativně rezervovaných tokenů. Pro celou firmu platí 240 / 1 000 požadavků, 1 200 / 4 000 stran a 24 / 100 milionů rezervovaných tokenů. Každý OCR pokus spotřebuje 20 stran, textový pokus 160 000 tokenů jako bezpečný horní odhad pro nejvýše 24 000 vstupních znaků, JSON/systémový text a 4 096 výstupních tokenů. Jde o ochranné pracovní kvóty, nikoli vykazovanou skutečnou spotřebu či cenu. Počítají se i nedokončené a neúspěšné pokusy; opakování stejného request ID kvótu nepřidává. Při vyčerpání endpoint vrátí 429 před placeným voláním. Měsíční USD limit firmy platí současně.
