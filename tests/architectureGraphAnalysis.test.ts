...
describe("architecture graph analysis", () => {
  ...
  it("analyzes the complete graph induced by the configured source roots", () => {
    ...
    expect(rawGraph.nodes).toHaveLength(676);
    expect(rawGraph.edges).toHaveLength(2111);
    expect(resolvedGraph.edges).toHaveLength(1796);
    ...
    expect(analysis.stronglyConnectedComponents).toHaveLength(674);
