...
describe("architecture graph analysis", () => {
  ...
  it("analyzes the complete graph induced by the configured source roots", () => {
    ...
    expect(rawGraph.nodes).toHaveLength(643);
    expect(rawGraph.edges).toHaveLength(1974);
    expect(resolvedGraph.edges).toHaveLength(1670);
    ...
    expect(analysis.stronglyConnectedComponents).toHaveLength(641);
