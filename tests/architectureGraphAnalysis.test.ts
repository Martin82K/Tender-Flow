...
describe("architecture graph analysis", () => {
  ...
  it("analyzes the complete graph induced by the configured source roots", () => {
    ...
    expect(rawGraph.nodes).toHaveLength(684);
    expect(rawGraph.edges).toHaveLength(2140);
    expect(resolvedGraph.edges).toHaveLength(1825);
    ...
    expect(analysis.stronglyConnectedComponents).toHaveLength(682);
